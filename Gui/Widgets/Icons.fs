...
module Icons =
    ...
    let axiomOne color =
        ImageBrush.fromString "avares://Assets/Axiom_1.png"

    let axiomTwo color =
        ImageBrush.fromString "avares://Assets/Axiom_2.png"

    let axiomThree color =
        ImageBrush.fromString "avares://Assets/Axiom_3.png"
